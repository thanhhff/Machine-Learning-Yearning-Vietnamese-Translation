## MỤC LỤC
- [x] [Giới thiệu](#p00)
	- [x] [1. Tại sao cần chiến lược Học Máy](#ch01)
	- [x] [2. Cách sử dụng cuốn sách khi làm việc nhóm](#ch02)
	- [x] [3. Kiến thức tiền đề và Ký hiệu](#ch03)
	- [x] [4. Quy mô là động lực phát triển học máy](#ch04)
- [x] [Phần 1: Chuẩn bị tập phát triển và tập kiểm tra](#p01)
	- [x] [5. Tập phát triển và tập kiểm tra](#ch05)
	- [x] [6. Tập phát triển và tập kiểm tra nên có cùng phân phối](#ch06)
	- [x] [7. Tập phát triển/kiểm tra cần lớn đến mức nào?](#ch07)
	- [x] [8. Thiết lập một phép đo đơn trị làm mục tiêu tối ưu](#ch08)
	- [x] [9. Phép đo để tối ưu và phép đo thỏa mãn](#ch09)
	- [x] [10. Xây dựng một tập phát triển và một phép đo sẽ tăng tốc quá trình làm việc](#ch10)
	- [x] [11. Khi nào cần thay đổi tập phát triển/kiểm tra và các phép đo](#ch11)
	- [x] [12. Điều cần nhớ: Thiết lập các tập phát triển và kiểm tra](#ch12)
- [x] [Phần 2: Phân tích lỗi cơ bản](#p02)
	- [x] [13. Bạn mong muốn xây dựng một hệ thống phòng chống email rác mới. Nhóm của bạn có rất nhiều ý tưởng:](#ch13)
	- [x] [14. Phân tích lỗi: đánh giá ý tưởng dựa trên tập phát triển](#ch14)
	- [x] [15. Đánh giá song song các ý tưởng trong quá trình phân tích lỗi](#ch15)
	- [x] [16. Dọn dẹp những mẫu bị gán nhãn nhầm trong tập phát triển và tập kiểm tra](#ch16)
	- [x] [17. Nếu bạn có một tập phát triển lớn, chia nó thành hai tập con và chỉ phân tích trên một tập](#ch17)
	- [x] [18. Tập phát triển Eyeball và Blackbox nên lớn như thế nào?](#ch18)
	- [x] [19. Điều cần nhớ: Phân tích lỗi cơ bản](#ch19)
